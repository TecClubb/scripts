...
# Configuration
# ===============================
PROJECT_PATH="/var/www/safeprovpn"
BRANCH="main"  # Change to 'master' or your branch name
PROJECT_NAME="safeprovpn"
BACKUP_PATH="/var/backups/laravel"
...
echo ""
print_status "Your application is now live with the latest changes!  🚀"
echo ""
